...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-05-2022 a las 23:21:19
...
INSERT INTO `locations` (`id`, `lat`, `lng`, `title`, `description`, `propietario`, `producto`) VALUES
(10, '-0.77305334426997', '-78.65279773813381', 'Cotopaxi(Tanicuchi)', 'Esto es una gran descripción para esta coordenada.', 'Juan Perez', 'Frejol'),
(11, '-0.7821505591832469', ' -78.65914920854547', 'Cotopaxi(Tanicuchi)', 'Esto es una gran descripción para esta coordenada.', 'ACHOTE	YANCHAGUANO JHADIRA MISHELL', 'papas'),
(12, '-0.7811206867823793', '-78.64936451088428', 'Cotopaxi(Tanicuchi)', 'Esto es una gran descripción para esta coordenada.', 'AGUILAR	INGA	OMAR SAMAEL', 'habas'),
(13, '-0.7672173848040682', ' -78.65022281769667', 'Cotopaxi(Tanicuchi)', 'Esto es una gran descripción para esta coordenada.', 'ANARUMBA	ULLOA	JOHNNY FRANCISCO', 'cevada'),
(14, '-0.7757996753646366', ' -78.66258243579502', 'Cotopaxi(Tanicuchi)', 'Esto es una gran descripción para esta coordenada.', 'BANDA	LLANGANATE	DAVID ALEXANDER', 'trigo'),
